                        ...
                        <address class="side-icon-boxes">
                            ...
                            <div class="side-icon-box">
                                ...
                                <p><strong>Telephone: </strong>
                                    <a href="callto:6282282855221">+62 8228 2855 221</a> <br />
                                </p>
                            </div>
                            <div class="side-icon-box">
                                <div class="side-icon">
                                ...
                                <p><strong>E-mail: </strong>
                                    <a href="mailto:admin@avessor.com">admin@avessor.com</a> <br />
                                </p>
                            </div>
                        </address>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 text-center">
                        <p>&copy;Copyright 2018 All right reserved.  AVESSOR - Indonesia</p>
                    </div>
                </div>
            </div>
        </div>
